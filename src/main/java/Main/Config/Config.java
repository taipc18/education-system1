...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/saukhithanhtoan";
    public static String vnp_TmnCode = "22UINI9Q";
    public static String vnp_HashSecret = "CFMCOIIAVUXNVMUUPWNEEGFUGXZDPLDM";
